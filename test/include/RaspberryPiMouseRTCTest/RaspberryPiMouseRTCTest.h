  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  /*!
   */
  InPort<RTC::TimedVelocity2D> m_current_velocity_outIn;
  RTC::TimedPose2D m_current_pose_out;
  /*!
   */
  InPort<RTC::TimedPose2D> m_current_pose_outIn;
  RTC::TimedShortSeq m_ir_sensor_out;
  /*!
   */
  InPort<RTC::TimedShortSeq> m_ir_sensor_outIn;
  RTC::TimedBooleanSeq m_switch3bit_out;
  /*!
   */
  InPort<RTC::TimedBooleanSeq> m_switch3bit_outIn;
  ...
  /*!
   */
  OutPort<RTC::TimedVelocity2D> m_target_velocity_inOut;
  RTC::TimedPose2D m_pose_update_in;
  /*!
   */
  OutPort<RTC::TimedPose2D> m_pose_update_inOut;
  RTC::TimedShort m_buzzer_hz_in;
  /*!
   */
  OutPort<RTC::TimedShort> m_buzzer_hz_inOut;
  RTC::TimedBooleanSeq m_led4bit_in;
  /*!
   */
  OutPort<RTC::TimedBooleanSeq> m_led4bit_inOut;
